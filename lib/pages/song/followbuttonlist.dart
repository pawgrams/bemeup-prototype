// Datei: pages\song\followbuttonlist.dart
import 'package:flutter/material.dart';
import '../user/profile/buttonstyle.dart';
...
class FollowButtonList extends StatelessWidget {
  final VoidCallback onPressed;
  const FollowButtonList({super.key, required this.onPressed});

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: panelStyle['followButtonHeight'] - 6,
      child: Transform.translate(
        ...
        child: TextButton(
          ...
          child: Text(
            'Follow',
            style: TextStyle(
              fontSize: panelStyle['followButtonFontSize'] - 3,
